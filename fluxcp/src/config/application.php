...
return array(
	...
	'InstallerPassword'			=> getenv('DB_PASSWORD') ?: 'XXXXXXXX',		// Installer/updater password.
	...
	'DefaultLanguage'			=> 'zh_cn',					// Specify the default control panel language (see FLUX_ROOT/lang/ directory for available languages.)
